                  ...
                  <div class="group-list">                
                   ...
                   <div class="group-list">                
                        <div class="row">                          
                              <div class="form-group col-md-4" >                        
                                  <label>Sex</label>
                                  <input type="text"  name="sex"  class="form-control" value="<?= $_SESSION['sex']; ?>" disabled>                   
                              </div>
                              <div class="form-group col-md-4" >
                                  <label>Marital Status</label>
                                  <input type="text" name="mstatus" value="<?= $_SESSION['mstatus']; ?>"  class="form-control"  disabled >
                              </div>                              
                  ...
                  <div class="group-list">                
                        <div class="row">                          
                              <div class="form-group col-md-4" >                        
                                  ...
                                  <input type="text" name="cstudy" value="<?= $_SESSION['ccstudy']; ?>" class="form-control" disabled> 
                                          
                              </div>
                              <div class="form-group col-md-4" >
                                  <label for="inputAddress">Level</label>
                                  <input id="inputLevel" value="<?= $_SESSION['clevel']; ?>" name="clevel" class="form-control" disabled>                                                
                              </div>
                              
                              <div class="form-group col-md-4">                           
                                    <label for="inputAddress">Departement</label>
                            <input id="inputDepartement" name="cdepartment" value="<?= $_SESSION['cdepartement']; ?>" class="form-control" disabled>                                                                       
                              </div>
                      </div>
                  </div>
              </div>         
               ...
               <div class="form-row col-12">
                          <div class="col-md-6">
                              <label for="inputAddress">Phone Number 1</label>
                                <input type="text"  name="phone1" class="form-control" value="<?= $_SESSION['phone1']; ?>" disabled>
                          </div>
                           <div class="col-md-6">
                              <label for="inputAddress">Phone Number 2</label>
                              <input type="text"  name="phone2" class="form-control" value="<?= $_SESSION['phone2']; ?>" disabled>
                            </div>
                            <div class="col-md-6">
          ...
          <div class="col-md-8"> 
              <div class="group-list">                
                  <div class="row">                          
                        ...
                        <input  type="text" name="pmaddress" class="form-control" value="<?= $_SESSION['permaddress']; ?>" disabled>
                        </div>
                  </div>
                  <div class="row">                          
                        <div class="form-group col-md-12">                          
                        <label for="inputAddress">Postal Address</label>
                        <input  type="text" name="psaddress" class="form-control" id="inputAddress" value="<?= $_SESSION['postaddress']; ?>" disabled>
               ...
               <div class="form-row col-12">
                          <div class="col-md-12">
                              <label for="inputAddress">1st Kin Name</label>
                                <input type="text"   class="form-control" value="<?= $_SESSION['kinname1']; ?>" disabled>
                          </div>                           
                            <div class="col-md-12">
                              <label for="inputAddress">2nd Kin Name</label>
                              <input type="text"  name="stateoorigin" class="form-control" value="<?= $_SESSION['kinname2']; ?>" disabled>
                            </div>                                                  
            </div>           
          </div>
          <div class="col-md-8"> 
              <div class="group-list">                
                  <div class="row">                          
                        ...
                        <input  type="text" name="pmaddress" class="form-control" id="inputAddress" value="<?= $_SESSION['kinaddnnum1']; ?>" disabled>           
                        </div>
                  </div>
                  <div class="row">                          
                        <div class="form-group col-md-12">                          
                        <label for="inputAddress">Seccond Next Of Kin Address/Phone No.</label>
                        <input type="text" name="psaddress" class="form-control" id="inputAddress" value="<?= $_SESSION['kinaddnnum2']; ?>" disabled>           
                        </div>
                  </div>
